...
namespace BOOKM1.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AuthorId,Name,Dob,DOJ,Sex,Lang1,Lang2,Salary")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AuthorId,Name,Dob,DOJ,Sex,Lang1,Lang2,Salary")] Author author)
        {
